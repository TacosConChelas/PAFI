...
public class JFProvedores extends javax.swing.JFrame {
    ...
    private void jBAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAgregarActionPerformed
        ...
        String sqlInsertar="insert into proveedor values (" + idProveedor + ", '" + nameP + "', '" + email + "', '" + direccion + "', '" + compania + "', '" + mercancia + "');";
    ...
    private void jBEliminarPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEliminarPActionPerformed
        ...
        int idProducto = Integer.parseInt(this.jTFIdProveedor.getText());
        
        String sqlDelete = "delete from proveedor where idProveedor = " + idProducto + ";" ;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFProvedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFProvedores().setVisible(true);
            }
        });
    }
