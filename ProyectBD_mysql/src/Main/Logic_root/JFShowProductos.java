 ...
 */
public class JFShowProductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTShowEmpleados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id Producto", "Nombre", "Decripción", "Precio Venta", "Cantidad"
            }
        ) {
    ...
    public void showProducts(){
        ...
        String sqlEmpleados = "select idProducto, NombreP, Descripcion, PrecioVenta, Cantidad from producto;";
         ...
         try{
            ...
            modeloProductos = (DefaultTableModel)this.jTShowEmpleados.getModel();
            while(rs.next()){
                productos[0] = rs.getInt("idProducto");
                productos[1] = rs.getString("NombreP");
                productos[2] = rs.getString("Descripcion");
                productos[3] = rs.getInt("PrecioVenta"); 
                productos[4] = rs.getInt("Cantidad");
                        
                modeloProductos.addRow(productos);    
            }
            this.jTShowEmpleados.setModel(modeloProductos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFShowProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFShowProductos().setVisible(true);
            }
        });
    }
